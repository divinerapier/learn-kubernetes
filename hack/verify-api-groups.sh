...
prefix="${KUBE_ROOT%"github.com/divinerapier/learn-kubernetes"}"
...
for register_file in "${register_files[@]}"; do
	...
	group_dirname="${package#"github.com/divinerapier/learn-kubernetes/pkg/apis/"}"
...
packages_without_install=(
	"github.com/divinerapier/learn-kubernetes/pkg/apis/abac"
	"github.com/divinerapier/learn-kubernetes/pkg/apis/admission"
	"github.com/divinerapier/learn-kubernetes/pkg/apis/componentconfig" # TODO: Remove this package completely and from this list
)
known_version_files=(
