...
def version_x_defs():
    ...
    stamp_pkgs = [
        "github.com/divinerapier/learn-kubernetes/vendor/k8s.io/component-base/version",
        "github.com/divinerapier/learn-kubernetes/vendor/k8s.io/client-go/pkg/version",
    ]
