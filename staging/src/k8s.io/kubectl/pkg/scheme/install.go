...
// The code in this file mostly duplicate the install under github.com/divinerapier/learn-kubernetes/pkg/api and github.com/divinerapier/learn-kubernetes/pkg/apis,
