...
func (g *Generator) BindFlags(flag *flag.FlagSet) {
	...
	flag.StringSliceVar(&g.ProtoImport, "proto-import", g.ProtoImport, "The search path for the core protobuf .protos, required; defaults $GOPATH/src/github.com/divinerapier/learn-kubernetes/vendor/github.com/gogo/protobuf/protobuf.")
