...
func main() {
	...
	genericArgs.OutputPackagePath = "github.com/divinerapier/learn-kubernetes/pkg/client/clientset_generated/"

	genericArgs.AddFlags(pflag.CommandLine)
	customArgs.AddFlags(pflag.CommandLine, "github.com/divinerapier/learn-kubernetes/pkg/apis") // TODO: move this input path out of client-gen
