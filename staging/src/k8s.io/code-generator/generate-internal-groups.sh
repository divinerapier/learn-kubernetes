...
ALL_FQ_APIS=() # e.g. github.com/divinerapier/learn-kubernetes/pkg/apis/apps k8s.io/api/apps/v1
INT_FQ_APIS=() # e.g. github.com/divinerapier/learn-kubernetes/pkg/apis/apps
