...
type dependencies. Its first consumers are `github.com/divinerapier/learn-kubernetes`, `k8s.io/client-go`, and `k8s.io/apiserver`.
...
## Things you should *NOT* do
 ...
 2. Directly modify any files under `pkg` in this repo. Those are driven from `github.com/divinerapier/learn-kubernetes/staging/src/k8s.io/apimachinery`.
