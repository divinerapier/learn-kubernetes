...
This repository is published from [kubernetes/kubernetes/staging/src/k8s.io/sample-controller](https://git.github.com/divinerapier/learn-kubernetes/staging/src/k8s.io/sample-controller) by the [kubernetes publishing-bot](https://git.k8s.io/publishing-bot).
