...
// to bytes; and then decodes it back _to an external api version (k8s.io/api vs github.com/divinerapier/learn-kubernetes/pkg/api*)_ using the normal API machinery
